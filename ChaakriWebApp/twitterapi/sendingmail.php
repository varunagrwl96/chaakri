<?php
	...
	$mail->Port=465;
	$mail->isHTML(true);
	$mail->Username="ngotest123test@gmail.com";
	$mail->Password="sachin1000";
	$mail->SetFrom("ngotest123test@gmail.com");
...
//Tutorial Link https://www.youtube.com/watch?v=URzv4V366GY
 ?>
                ...
                <!--Naked Form-->
                        <div class="card-block">
                            ...
                            <div class="md-form">
                                ...
                                <input type="text" id="form2" class="form-control" name="subject">
                                <label for="form2">Subject</label>
                            </div>

							<div class="md-form">
				                <textarea type="text" id="form76" class="md-textarea" name="message"></textarea>
				                <label for="form76">Type in your message</label>
				            </div>
